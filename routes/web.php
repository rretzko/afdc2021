...
Route::group(['middleware' => 'auth'],function(){
    ...
    Route::get('/eventadministrator/tabroom/reports/{eventversion}/auditionresults', [App\Http\Controllers\Eventadministration\ReportsAuditionresultsController::class, 'index'])
